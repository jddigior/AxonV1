...
void loop() {
  ...
  if (stepper5.distanceToGo() == 0 && stepper6.distanceToGo() == 0){
    delay(2000);
    switch (moveCounter % 8) {
      case 0: moveBC(90, -45); break;
      case 1: moveBC(90, 90); break;
      case 2: moveBC(30, 180); break;
      case 3: moveBC(-30, -180); break;
      case 4: moveBC(-60, 0); break;
      case 5: moveBC(60, -30); break;
      case 6: moveBC(-12, 12.3); break;
      case 7: moveBC(0, 0); break;
    } 
  ...
  if (Serial.available()) {
    ...
    double posB = input.substring(0, input.indexOf(' ')).toDouble();
    double posC = input.substring(input.indexOf(' ') + 1).toDouble();
    Serial.println(posB);
    Serial.println(posC);
